...
{
    inline const char *ResolveCapabilityTier(const VulkanPhyDevice &pd)
    {
    ...
    inline const char *ResolveDeviceTypeName(const VkPhysicalDeviceType type)
    {
        switch (type)
        {
    ...
    inline PhysicalDeviceProfileLite BuildPhysicalDeviceProfileFromVulkanPhyDevice(const VulkanPhyDevice &pd)
    {
