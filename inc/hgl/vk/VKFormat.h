...
// 语义别名格式（便于后续统一切换）
// Position
#define VK_FORMAT_POSITION_3D          VK_FORMAT_R32G32B32_SFLOAT
#define VK_FORMAT_POSITION_2D          VK_FORMAT_R32G32_SFLOAT
#define VK_FORMAT_POSITION_3D_INT      VK_FORMAT_R32G32B32_SINT
#define VK_FORMAT_POSITION_2D_INT      VK_FORMAT_R32G32_SINT

// Normal (default + compact candidates)
#define VK_FORMAT_NORMAL               VK_FORMAT_R32G32B32_SFLOAT
#define VK_FORMAT_NORMAL_OCT16         VK_FORMAT_R16G16_SFLOAT
#define VK_FORMAT_NORMAL_OCT8_UNORM    VK_FORMAT_R8G8_UNORM
#define VK_FORMAT_NORMAL_OCT8_SNORM    VK_FORMAT_R8G8_SNORM
#define VK_FORMAT_NORMAL_PACK_1010102  VK_FORMAT_A2B10G10R10_SNORM_PACK32
...
#define VK_FORMAT_TANGENT_PACK_1010102 VK_FORMAT_A2B10G10R10_SNORM_PACK32

// TexCoord
#define VK_FORMAT_TEXCOORD             VK_FORMAT_R32G32_SFLOAT
#define VK_FORMAT_TEXCOORD_HALF        VK_FORMAT_R16G16_SFLOAT
#define VK_FORMAT_TEXCOORD_UNORM16     VK_FORMAT_R16G16_UNORM
#define VK_FORMAT_TEXCOORD_UNORM8      VK_FORMAT_R8G8_UNORM

// Vertex Color
#define VK_FORMAT_COLOR                VK_FORMAT_R32G32B32A32_SFLOAT
#define VK_FORMAT_COLOR_HALF           VK_FORMAT_R16G16B16A16_SFLOAT
#define VK_FORMAT_COLOR_UNORM8         VK_FORMAT_R8G8B8A8_UNORM
#define VK_FORMAT_COLOR_SRGB8          VK_FORMAT_R8G8B8A8_SRGB
#define VK_FORMAT_COLOR_PACK_1010102   VK_FORMAT_A2B10G10R10_UNORM_PACK32

// Luminance / Intensity
#define VK_FORMAT_LUMINANCE            VK_FORMAT_R32_SFLOAT
#define VK_FORMAT_LUMINANCE_HALF       VK_FORMAT_R16_SFLOAT
#define VK_FORMAT_LUMINANCE_UNORM16    VK_FORMAT_R16_UNORM
#define VK_FORMAT_LUMINANCE_UNORM8     VK_FORMAT_R8_UNORM

// ORM (Occlusion-Roughness-Metallic packed channels)
#define VK_FORMAT_ORM                  VK_FORMAT_R8G8B8A8_UNORM
#define VK_FORMAT_ORM_RGBA8            VK_FORMAT_R8G8B8A8_UNORM
#define VK_FORMAT_ORM_UNORM16          VK_FORMAT_R16G16B16_UNORM

// Split channels for material masks
#define VK_FORMAT_OCCLUSION            VK_FORMAT_R8_UNORM
#define VK_FORMAT_ROUGHNESS            VK_FORMAT_R8_UNORM
#define VK_FORMAT_METALLIC             VK_FORMAT_R8_UNORM

// Emissive / Albedo defaults
#define VK_FORMAT_ALBEDO               VK_FORMAT_R8G8B8A8_SRGB
#define VK_FORMAT_EMISSIVE             VK_FORMAT_R16G16B16A16_SFLOAT
