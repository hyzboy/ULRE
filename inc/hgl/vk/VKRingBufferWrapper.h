...
public:
    RingBufferWrapper(VkBufferOwner *buf = nullptr,
    ...
    void SetBuffer(VkBufferOwner *buf) { writer.SetBuffer(buf); }
    ...
    void MarkDirty();
    bool CommitInternal();
    VkBufferOwner* GetBuffer();
    const VkBufferOwner* GetBuffer() const;
};
}
