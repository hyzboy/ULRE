...
namespace hgl::ecs
{
    ...
    private:
        // === 核心标识 ===
        graph::ShaderMaterialProgram* material;                          ///<材质
        graph::GraphicsPipeline* pipeline;                          ///<管线
    ...
    public:
        PipelineMaterialRenderer(graph::ShaderMaterialProgram* m, graph::GraphicsPipeline* p);
