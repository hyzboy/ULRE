static void BuildScaleAssetVisual(GizmoECS *gizmo, hgl::ecs::Entity *parent)
{
    ...
    {
        AttachAssetModePrimitive(gizmo->scale_mode.primitives, center, GizmoShape::Cube, GizmoColor::White);
    }
    ...
    for (int i = 0; i < 3; ++i)
    {
        ...
        {
            AttachAssetModePrimitive(gizmo->scale_mode.primitives, cyl, GizmoShape::Cylinder, cfg.color, i);
        }
        ...
        {
            AttachAssetModePrimitive(gizmo->scale_mode.primitives, tip, GizmoShape::Cube, cfg.color, i);
        }
        ...
        {
            AttachAssetModePrimitive(gizmo->scale_mode.primitives, plane, GizmoShape::Square, cfg.color);
        }
    }
}
