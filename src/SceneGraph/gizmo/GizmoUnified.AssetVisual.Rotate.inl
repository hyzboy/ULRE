static void BuildRotateAssetVisual(GizmoECS *gizmo, hgl::ecs::Entity *parent)
{
    ...
    for (int i = 0; i < 3; ++i)
    {
        ...
        {
            AttachAssetModePrimitive(gizmo->rotate_mode.primitives, torus, GizmoShape::Torus, cfg.color, i);
        }
    }
    ...
    if (auto *white_torus = CreateAssetVisualEntity(gizmo,
                                                    ...
                                                    &gizmo->rotate_mode.aux_transform))
    {
        AttachAssetModePrimitive(gizmo->rotate_mode.primitives, white_torus, GizmoShape::Torus, GizmoColor::White, 3);
    }
}
