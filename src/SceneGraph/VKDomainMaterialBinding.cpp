...
bool DomainMaterialBinding::BindTexture(const DescriptorSetType &type, const AnsiString &name, Texture *tex)
{
...
bool DomainMaterialBinding::BindTextureSampler(const DescriptorSetType &type, const AnsiString &name,
