...
namespace hgl::graph
{
    ...
    bool DescriptorBindingSet::SetSSBOBinding(const mtl::SSBOType ssbo_type, const uint32_t ssbo_id, const uint32_t ssbo_slot)
    {
        ...
        ssbo_bindings[index].ssbo_slot = ssbo_slot;
        return true;
    }
