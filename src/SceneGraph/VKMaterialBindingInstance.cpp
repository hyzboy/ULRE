...
MaterialBindingInstance::MaterialBindingInstance(ShaderMaterialProgram *mtl, ResourceDomain *d, const int id)
    : material(mtl), domain(d), domain_id(d ? d->GetDomainID() : 0xFFFFFFFFu), mi_id(id)
{
