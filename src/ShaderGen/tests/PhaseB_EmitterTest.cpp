...
static void test_single_provider_changes_hash()
{
    ...
    modified.attribute_providers[size_t(VertexAttrib::Normal)] = AttributeProviderId::SSBO_Vec3;
...
static void test_different_slots_differ()
{
    ...
    key_normal.attribute_providers[size_t(VertexAttrib::Normal)] = AttributeProviderId::SSBO_Vec3;

    MaterialVariantKey key_tangent{};
    key_tangent.attribute_providers[size_t(VertexAttrib::Tangent)] = AttributeProviderId::SSBO_Vec3;
...
{
    MaterialVariantKey key{};
    key.attribute_providers[size_t(VertexAttrib::Normal)] = AttributeProviderId::SSBO_Vec3;
