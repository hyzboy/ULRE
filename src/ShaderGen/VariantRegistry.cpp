...
static const BuiltinVariantEntry kBuiltinVariants[] =
{
    ...
    // ── Sprite2D ──────────────────────────────────────────────────────────────────────────────────
    { .name = "Sprite2DDynamicOpaque",      .preset = MaterialPreset::Sprite2DCameraFacing,
      .geometry_mode = GM::Sprite2DCameraFacing,  .blend = RM::Opaque,          .pass = PT::ForwardOpaque,
      .extra_bits = EX(ExtraFeature::Vec2Position), .tex = {{ Slot::BaseColor, TSM::Simple }},
      .vs_path = "compositor/main_forward_sprite2d_dynamic.vert.glsl",
      .fs_path = "compositor/main_forward_billboard.frag.glsl",
      .surface_path = "surface/billboard_texture_surface.glsl" },

    { .name = "Sprite2DDynamic",            .preset = MaterialPreset::Sprite2DCameraFacing,
      .geometry_mode = GM::Sprite2DCameraFacing,  .blend = RM::Transparent,     .pass = PT::ForwardTransparent,
      .extra_bits = EX(ExtraFeature::Vec2Position), .tex = {{ Slot::BaseColor, TSM::Simple }},
      .vs_path = "compositor/main_forward_sprite2d_dynamic.vert.glsl",
      .fs_path = "compositor/main_forward_billboard.frag.glsl",
      .surface_path = "surface/billboard_texture_surface.glsl" },

    { .name = "Sprite2DDynamicMasked",      .preset = MaterialPreset::Sprite2DCameraFacing,
      .geometry_mode = GM::Sprite2DCameraFacing,  .blend = RM::Masked,          .pass = PT::ForwardMasked,
      .extra_bits = EX(ExtraFeature::Vec2Position), .tex = {{ Slot::BaseColor, TSM::Simple }},
      .vs_path = "compositor/main_forward_sprite2d_dynamic.vert.glsl",
      .fs_path = "compositor/main_forward_billboard.frag.glsl",
      .surface_path = "surface/billboard_texture_surface.glsl" },

    { .name = "Sprite2DDynamicDither",      .preset = MaterialPreset::Sprite2DCameraFacing,
      .geometry_mode = GM::Sprite2DCameraFacing,  .blend = RM::Dither,          .pass = PT::ForwardDither,
      .extra_bits = EX(ExtraFeature::Vec2Position), .tex = {{ Slot::BaseColor, TSM::Simple }},
      .vs_path = "compositor/main_forward_sprite2d_dynamic.vert.glsl",
      .fs_path = "compositor/main_forward_billboard.frag.glsl",
      .surface_path = "surface/billboard_texture_surface.glsl" },

    { .name = "Sprite2DDynamicA2C",         .preset = MaterialPreset::Sprite2DCameraFacing,
      .geometry_mode = GM::Sprite2DCameraFacing,  .blend = RM::AlphaToCoverage, .pass = PT::ForwardA2C,
      .extra_bits = EX(ExtraFeature::Vec2Position), .tex = {{ Slot::BaseColor, TSM::Simple }},
      .vs_path = "compositor/main_forward_sprite2d_dynamic.vert.glsl",
      .fs_path = "compositor/main_forward_billboard.frag.glsl",
      .surface_path = "surface/billboard_texture_surface.glsl" },

    { .name = "Sprite2DFixedOpaque",        .preset = MaterialPreset::Sprite2DAxisLocked,
      .geometry_mode = GM::Sprite2DAxisLocked,    .blend = RM::Opaque,          .pass = PT::ForwardOpaque,
      .extra_bits = EX(ExtraFeature::Vec2Position), .tex = {{ Slot::BaseColor, TSM::Simple }},
      .vs_path = "compositor/main_forward_sprite2d_fixed.vert.glsl",
      .fs_path = "compositor/main_forward_billboard.frag.glsl",
      .surface_path = "surface/billboard_texture_surface.glsl" },

    { .name = "Sprite2DFixed",              .preset = MaterialPreset::Sprite2DAxisLocked,
      .geometry_mode = GM::Sprite2DAxisLocked,    .blend = RM::Transparent,     .pass = PT::ForwardTransparent,
      .extra_bits = EX(ExtraFeature::Vec2Position), .tex = {{ Slot::BaseColor, TSM::Simple }},
      .vs_path = "compositor/main_forward_sprite2d_fixed.vert.glsl",
      .fs_path = "compositor/main_forward_billboard.frag.glsl",
      .surface_path = "surface/billboard_texture_surface.glsl" },

    { .name = "Sprite2DFixedMasked",        .preset = MaterialPreset::Sprite2DAxisLocked,
      .geometry_mode = GM::Sprite2DAxisLocked,    .blend = RM::Masked,          .pass = PT::ForwardMasked,
      .extra_bits = EX(ExtraFeature::Vec2Position), .tex = {{ Slot::BaseColor, TSM::Simple }},
      .vs_path = "compositor/main_forward_sprite2d_fixed.vert.glsl",
      .fs_path = "compositor/main_forward_billboard.frag.glsl",
      .surface_path = "surface/billboard_texture_surface.glsl" },

    { .name = "Sprite2DFixedDither",        .preset = MaterialPreset::Sprite2DAxisLocked,
      .geometry_mode = GM::Sprite2DAxisLocked,    .blend = RM::Dither,          .pass = PT::ForwardDither,
      .extra_bits = EX(ExtraFeature::Vec2Position), .tex = {{ Slot::BaseColor, TSM::Simple }},
      .vs_path = "compositor/main_forward_sprite2d_fixed.vert.glsl",
      .fs_path = "compositor/main_forward_billboard.frag.glsl",
      .surface_path = "surface/billboard_texture_surface.glsl" },

    { .name = "Sprite2DFixedA2C",           .preset = MaterialPreset::Sprite2DAxisLocked,
      .geometry_mode = GM::Sprite2DAxisLocked,    .blend = RM::AlphaToCoverage, .pass = PT::ForwardA2C,
      .extra_bits = EX(ExtraFeature::Vec2Position), .tex = {{ Slot::BaseColor, TSM::Simple }},
      .vs_path = "compositor/main_forward_sprite2d_fixed.vert.glsl",
      .fs_path = "compositor/main_forward_billboard.frag.glsl",
      .surface_path = "surface/billboard_texture_surface.glsl" },
