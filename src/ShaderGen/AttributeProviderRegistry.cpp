...
namespace hgl::graph
{
    ...
    static const AttributeProvider kBuiltins[] =
    {
        ...
        { Id::SSBO_Vec2,            Sem::TexCoord,         "ShaderLibrary/attribute_provider/ssbo_vec2.glsl",                       true,  false, false,  8 },
        ...
        { Id::SSBO_PackedUV_2x16,   Sem::TexCoord,         "ShaderLibrary/attribute_provider/ssbo_packed_uv_2x16.glsl",             true,  false, false,  4 },
