...
namespace
{
    ...
    static GateResult RunBindlessEquivalenceCase()
    {
        ...
        constexpr FixedDescriptorEntry standard_entries[] =
        {
            ...
            { DescriptorSetType::Material, MaterialInstanceDescriptorKind, uint32_t(VK_SHADER_STAGE_ALL_GRAPHICS), "mtl", "MaterialInstanceData", nullptr, DescriptorSemantic::MaterialInstance, TextureSlot::BaseColor, DefaultMaterialSSBOSlot, SSBOType::PBRSurface },
