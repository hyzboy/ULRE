                                            ...
                                            const GraphicsRenderState &state_profile)
{
    ...
    if (req.material)
    {
        ...
        HashBool(layout_hash, req.material->HasInstanceData());
        HashU32(layout_hash, req.material->GetInstanceDataStride());
        HashU32(layout_hash, req.material->GetInstanceMaxCount());
