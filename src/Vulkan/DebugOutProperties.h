...
inline void debug_out(const char *front,const std::vector<VkLayerProperties> &layer_properties)
{
    const int property_count=(int)layer_properties.size();
...
inline void debug_out(const char *front,const std::vector<VkExtensionProperties> &extension_properties)
{
    const int extension_count=(int)extension_properties.size();
