...
MaterialParameters *VulkanDevice::CreateMP(const MaterialDescriptorManager *desc_manager,const GraphicsPipelineLayoutData *pld,const DescriptorSetType &desc_set_type)
{
    ...
    LogInfo(U8_TEXT("Create [DescriptSets:")+addr_string+U8_TEXT("] OK! ShaderMaterialProgram Name: \"")+(const U8String &)(desc_manager->GetMaterialName())+U8_TEXT("\" Type: ")+(u8char *)(GetDescriptorSetTypeName(desc_set_type)));
#endif//_DEBUG
