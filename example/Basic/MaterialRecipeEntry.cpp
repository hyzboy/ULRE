...
private:
    ...
    bool InitMaterialDataSSBO()
    {
        ...
        material_data_ssbo_accessor = domain_manager->GetMaterialDataAccessor<graph::ssbo::EmissiveSurfaceRow>();
    ...
    bool InitECS()
    {
        ...
        named_struct = material_data_ssbo_accessor.GetMaterialSSBOBinding();
