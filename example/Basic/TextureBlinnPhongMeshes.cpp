...
class TextureBlinnPhongMeshesApp : public WorkObject
{
private:
...
{
    return RunFramework<TextureBlinnPhongMeshesApp>(OS_TEXT("Standard Meshes ECS (Texture Set)"), argc, argv, 1280, 720);
}
