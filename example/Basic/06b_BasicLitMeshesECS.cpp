...
private:
    ...
    bool InitMaterial()
    {
        ...
        // Initialize global bindless manager (Set 4) before material creation.
    ...
    bool InitBindlessTextureResources()
    {
        ...
        // Register Vulkan bindless descriptors + pool mapping (resource_id = texid:<id>).
        ...
        // Keep material->texture registry populated for Recipe extraction fallback.
