...
class FacingMeshBillboardZECSApp : public WorkObject
{
private:
...
private:
    ...
    bool InitSceneEntities()
    {
        ...
        for (size_t i = 0; i < mesh_count; ++i)
        {
            ...
            rm->entity = ecs_world->CreateEntity<Entity>("FacingMeshZ_" + std::to_string(i));
...
{
    return RunFramework<FacingMeshBillboardZECSApp>(OS_TEXT("Facing Mesh Billboard Z-Up ECS"), argc, argv, 1280, 720);
}
